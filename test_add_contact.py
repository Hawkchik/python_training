...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        wd.find_element_by_name("address").send_keys("1")
        ...
        wd.find_element_by_name("work").send_keys("1")
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").clear()
        wd.find_element_by_name("fax").send_keys("1")
        ...
        wd.find_element_by_name("homepage").send_keys("mail.ru")
        ...
        wd.find_element_by_name("address2").send_keys("next one")
